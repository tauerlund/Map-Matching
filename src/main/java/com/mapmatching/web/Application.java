...
public class Application {
	...
	// Enter file path of new map to import. Please see README for further
	// instructions.
	private final String OSM_PATH = "";
	...
	protected GraphHopperConfig makeGraphHopperConfiguration() {
		GraphHopperConfig graphHopperConfig = new GraphHopperConfig();

		// Import the map
		graphHopperConfig.putObject("graph.flag_encoders", "car");
		graphHopperConfig.putObject("datareader.file", OSM_PATH);
